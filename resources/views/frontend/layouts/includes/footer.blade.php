            ...
            <div
                ...
                <div class="footer-widget four">
                    ...
                    <div class="app-list">
                        <ul>
                            <li>
                                <a href="#"><img src="{{ asset('frontend') }}/images/icon/apple-app.svg" alt></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('frontend') }}/images/icon/google-play.svg"
                                        alt></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="footer-btm">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 d-flex justify-content-lg-start justify-content-center">
                    <div class="support">
                        <div class="icon">
                            <img src="{{ asset('frontend') }}/images/icon/footer-support-icon.svg" alt>
                        </div>
                        <div class="content">
                            <h5>Support Line:</h5>
