<header class="header-area style-1">
    <div class="header-main-logo d-lg-block d-none">
        <a href="index.html"><img alt="image" src="{{ asset('frontend') }}/images/header1-logo.svg"></a>
    </div>
                        ...
                        <div class="btn-group dropdown">
                            ...
                            <div class="notifacion-card dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                ...
                                <ul>
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('frontend') }}/images/bg/company-logo/notifacion-1.png"
                                                alt>
                                        </div>
                                        <div class="content">
                                            <h6><a href="#">Your application has accepted in 5 vacancies.</a>
                                            </h6>
                                            <span><img src="{{ asset('frontend') }}/images/icon/clock-1.svg" alt>
                                                10 min ago</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('frontend') }}/images/bg/company-logo/notifacion-2.png"
                                                alt>
                                        </div>
                                        <div class="content">
                                            <h6><a href="#">Your application has accepted in 5 vacancies.</a>
                                    ...
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('frontend') }}/images/bg/company-logo/notifacion-3.png"
                                                alt>
                                        </div>
                                        <div class="content">
                                            <h6><a href="#">Your application has accepted in 5 vacancies.</a>
                    ...
                    @auth
                        <li class="d-md-flex d-none">
                            <div class="sign-in-btn">
                                <a href="{{ route('logout') }}" class="primry-btn-1 lg-btn"
