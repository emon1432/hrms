                    ...
                    <div class="counter-area">
                        <div class="row g-lg-4 g-md-5 gy-5 justify-content-center">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="counter-single">
                                    <div class="counter-icon">
                                        <img src="{{ asset('frontend') }}/images/icon/companies.svg"
                                            alt="image">
                                    </div>
                                    <div class="coundown">
                                        <p>Companies</p>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="counter-single">
                                    <div class="counter-icon">
                                        <img src="{{ asset('frontend') }}/images/icon/candidates.svg"
                                            alt="image">
                                    </div>
                                    <div class="coundown">
                                        <p>Candidates</p>
        ...
        <div
            ...
            <div class="col">
                <div class="single-category">
                    ...
                    <div class="category-content">
                        <h5><a href="job-listing1.html">Marketing & Sales</a></h5>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('frontend') }}/images/bg/company-logo/trusted-company-01.png"
                                    alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('frontend') }}/images/bg/company-logo/trusted-company-02.png"
                                    alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('frontend') }}/images/bg/company-logo/trusted-company-03.png"
                                    alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('frontend') }}/images/bg/company-logo/trusted-company-04.png"
                                    alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('frontend') }}/images/bg/company-logo/trusted-company-05.png"
                                    alt>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('frontend') }}/images/bg/company-logo/trusted-company-06.png"
                                    alt>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
                <div class="recent-article-wrap">
                    ...
                    <div class="recent-article-content">
                        ...
                        <h4><a href="blog-details.html">To Make Your Smartness & Catch
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
                <div class="recent-article-wrap">
                    ...
                    <div class="recent-article-content">
                        ...
                        <h4><a href="blog-details.html">Be Confident Your Dream & Struggle
