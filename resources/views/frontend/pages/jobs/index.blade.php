                    ...
                    <div class="job-sidebar">
                        ...
                        <div class="job-widget mb-20">
                            <div class="check-box-item">
                                ...
                                <ul class="tags">
                                    <li><a href="{{ route('jobs.index') }}">Technology,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Marketing,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Sales,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Transport,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Medical,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Design,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Data Analyst,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Development,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Non-Profit,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Manager,</a></li>
                                    <li><a href="{{ route('jobs.index') }}">Health,</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="grid-select-area">
                                    ...
                                    <div class="grid-area">
                                        <ul>
                                            ...
                                            <li><a class="active" href="{{ route('jobs.index') }}">
